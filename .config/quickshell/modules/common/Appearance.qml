...
Singleton {
    ...
    property real transparency: ConfigOptions?.appearance.transparency ? (m3colors.darkmode ? 0.2 : 0.07) : 0
    ...
    m3colors: QtObject {
        ...
        property color m3background: "#1E140F"
        property color m3onBackground: "#d5c4a1"
        property color m3surface: "#241810"
        property color m3surfaceDim: "#241810"
        ...
        property color m3surfaceVariant: "#2a1c14"
        property color m3onSurfaceVariant: "#a1866f"
        property color m3inverseSurface: "#d5c4a1"
        property color m3inverseOnSurface: "#1E140F"
        property color m3outline: "#988E97"
        property color m3outlineVariant: "#4C444D"
        property color m3shadow: "#1a120b"
        property color m3scrim: "#000000"
        property color m3surfaceTint: "#b89c72"
        property color m3primary: "#b89c72"
        property color m3onPrimary: "#1a120b"
        property color m3primaryContainer: "#a1866f"
        property color m3onPrimaryContainer: "#1a120b"
        property color m3inversePrimary: "#b89c72"
        property color m3secondary: "#8b5e3c"
        property color m3onSecondary: "#1a120b"
        property color m3secondaryContainer: "#b08b3f"
        property color m3onSecondaryContainer: "#F2DCF3"
        property color m3tertiary: "#9c7a73"
        property color m3onTertiary: "#1a120b"
        property color m3tertiaryContainer: "#c2a192"
        property color m3onTertiaryContainer: "#1a120b"
        property color m3error: "#a07155"
        property color m3onError: "#1a120b"
        property color m3errorContainer: "#d0a96f"
        property color m3onErrorContainer: "#1a120b"
